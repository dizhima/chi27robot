...
On our laptop without a discrete GPU, per-step compilation latency was under one second for most steps, while some pick and place steps took up to five seconds because they required collision-checked motion search, including multi-seed inverse kinematics and, for reach-in placements, a bidirectional rapidly exploring random tree search.
