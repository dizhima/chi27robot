...
Each new motion is checked against the static scene and the spatiotemporal occupancy of previously committed steps.
When a conflict is detected, the compiler evaluates a bounded set of deterministic repairs: rerouting a navigation step, detouring a blocking robot, or serializing actions through a wait or precedence constraint.
